/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 818868435d8db8e8534c5fa9618b134f)
// Runtime types generated with workerd@1.20260916.1 2026-09-17 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	AUTH_BASE_URL: "https://auth.sharosoo.com";
	API_AUDIENCE: "https://omok.sharosoo.com";
	JEV_MODEL: "jev-latest";
	JEV_BASE_URL: "https://api.typesafe.ai";
	TYPESAFE_API_KEY: string;
	ROOM: DurableObjectNamespace<import("./src/worker/index").MatchRoom>;
	LOBBY: DurableObjectNamespace<import("./src/worker/index").Lobby>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_BASE_URL" | "API_AUDIENCE" | "JEV_MODEL" | "JEV_BASE_URL" | "TYPESAFE_API_KEY">> {}
}
